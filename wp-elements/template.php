...
if ( count( $sections ) > 0 ) :
?>
<div class="wp-elements-wrapper container-left  mt-5">
	<div class="row">
		<div class="col-md-4" style="margin-top: 0.5rem;">
			<div class="list-group">
				...
				?>
				<a href='https://github.com/picocodes/picosearch/' id='contact-link' class='list-group-item list-group-item-action'>Github</a>
			</div>
		</div>
